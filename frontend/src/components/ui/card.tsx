...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border bg-zinc-900/40 text-zinc-50 shadow-sm transition-colors focus-within:border-zinc-700 focus-within:ring-2 focus-within:ring-zinc-200/10",
      className
    )}
    {...props}
  />
